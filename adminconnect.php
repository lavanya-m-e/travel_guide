...
if (!$conn) {
    ...
    if($uemail=="admin@gmail.com" && $upassword=="admin")
    {
 ...
 <body>
   <div class="container-fluid bg">
       <div class="row">
           ...
           <div class="col-md-4 col-sm-4 col-xs-12">
           <!-- form start-->
           <form class="form-container" action="adminbooking.php" method="POST">
               <h3>HELLO ADMIN !!</h3>
               <div class="form-group">
                   <!--<label for="entername">Enter Name</label>
                   <input type="text" class="form-control" name="Name" placeholder="enter name">-->
                  
                   <button type="submit" name="Submit" class="btn btn-primary">VIEW BOOKINGS</button>
