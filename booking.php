...
$uemail=$_POST['Email'];
$sql="select c.Email,p.Pid,t.TName,t.Contact_no from c_account c,package p,travel_agency t where c.Email=p.Email and p.Pid=t.Pid and p.Email='$uemail'";
       ...
       <div class="row">
           ...
           <form class="form-container" action="travel_main.html" method="POST">
               ...
               <div class="form-group">
                   ...
                   <div class="button">
                        <a href="delete_booking.php" class="btn">CANCEL BOOKING</a>
